...
- 대회 초반 1시간(10:30~11:30)은 환경설정을 위해 키보드 사용이 가능합니다.
- 참가자의 주 개발 도구는 GitHub Copilot이며, GitHub Copilot이 지원하는 음성입력모드, OS 차원에서 제공하는 음성 입력 모드 모두 허용합니다.
- 코딩을 위한 키보드 조작은 제한되며, 일부 조작(예: 음성 입력모드 제어용 단축키 등)만 예외 허용됩니다.
- 경고 누적 시 실격(퇴장) 처리됩니다.
...
| 위반 항목                     | 설명                                    |
|-------------------------------|-----------------------------------------|
| GitHub Copilot 이외 제품 사용 | 타사 AI 코딩 에이전트 사용              |
