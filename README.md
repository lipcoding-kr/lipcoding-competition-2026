**제 2회 천하제일 입코딩 대회를 성황리에 끝마쳤습니다. 다음에 더욱 풍성한 행사로 여러분을 찾아뵙겠습니다**

# 천하제일 입코딩 대회 2026

<div>
  <p><img src="./images/hero.png" width="500" alt="천하제일입코딩대회 이미지"></p>
  <p style="font-size: 16pt; font-weight: bold;"><strong>제 2회 천하제일 입코딩대회에 오신 것을 환영합니다!</strong></p>
</div>
...
### 대상: JambalayaSeasoning | AIssistant

![대상](./results/1-prize-winner.jpg)

### 최우수상: SCG | PulsePlan

![최우수상](./results/2-prize-winner.jpg)

### 우수상: KillerSmith | 말그림 - Copilot과 말로 그리는 플로우차트

![우수상](./results/3-prize-winner.jpg)
